<div>
    ...
    <div class="modal-content animated slideInDown">
      ...
      <form style=" margin-top: 2%;"  method="POST" action="addcategorydb.php" enctype="multipart/form-data"> 
 <div class="form-group">
          <label for="category">Category :</label>
          <input type="text" class="form-control" placeholder="Eg Phones , Earphones , Covers" name="category">
        </div>
