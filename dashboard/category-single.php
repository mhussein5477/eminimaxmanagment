...
<body>
	...
	$category_id = $_GET['info'];
   $sql = $db->query("SELECT * FROM items WHERE category_id =  '$category_id'  ");
...
<br>
  ...
  <section id="printableArea" >
    <center>
       <h4 style="text-align: center; margin-top: 3%"><?php echo $details['name'] ?></h4>

      <div class="search" style="margin-top: 2%; margin-left: 14%" >
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $item['price'] ?></td>
      <td><?= $item['adate'] ?></td>
      <td><a href="deleteitem.php?info=<?= $item['id'] ?>" title="delete" class="delete" onclick="return confirm('Are you sure you want to delete this item')" style="color: red"><span class="fa fa-trash" style="font-size: 20px"></span></a> </td>
       <td>
        <a href="edite.php?info=<?= $item['id']?>">
