...
<section id="printableArea">
	...
	<div class="row" style="margin-top: 3%">
		...
		<div class="col" style="width: 100%">
			<?php 
			$currentdate = $_GET['info'];
			 $sql1 = $db->query("SELECT * FROM sales  WHERE sdate =  '$currentdate'  ");
			 $currentprice = 0;
			?>
		<h5 style="text-align: center; margin-top: 1%; color: red"><?php echo $currentdate; ?></h5>
		<table  class="table"  style="margin-left: 0%; margin-top: 5%; ">
		<tr>
			<th>id</th>
...
<h5 style="text-align: right; margin-bottom: 10% ">Total : <?php echo $currentprice; ?>  </h5>
		</div>
